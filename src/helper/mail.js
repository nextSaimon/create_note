...
export async function sendEmail(email, token, type) {
  ...
  const link = `${process.env.NEXTAUTH_URL}/${type === "verify" ? "verify" : "fp/reset"}?token=${token}`;
  ...
  <div style="min-height: 100vh; display: flex; justify-content: center; align-items: center; background-color: #f3f4f6; padding: 20px;">
    <div style="max-width: 600px; width: 100%; background-color: #fff; padding: 24px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
      <h2 style="font-size: 24px; font-weight: 600; color: #333; text-align: center;">Confirm your account</h2>
      ...
      <div style="margin-top: 24px; text-align: center;">
        <a href="${link}" style="background-color: #3b82f6; color: white; padding: 12px 24px; font-size: 16px; border-radius: 8px; text-decoration: none; display: inline-block;">Confirm</a>
      </div>
